...
export const New = () => {
  return (
    <>
    <Navigation />
    <Header title="i am new to emmasdale" />
    <Text />
    <OnlineWorship />
    <Normal title="our sabbath worship" paragraph="Our Sabbath Worship is packed with activities for the entire day with special program for each age"/>
    <WeeklyBulleting />
    <SabbathSchool />
    <NormalFlex 
    title="main service"
   ...
   />
   <Normal title="optionally, let us know you are coming:"
